...
<div class="wrapper row-offcanvas row-offcanvas-left"> 
  ...
  <aside class="right-side"> 
    ...
    <section class="content-header">
      <h1> DNS信息管理 <small>DNS信息</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
        <li><a href="#">DNS信息管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
              ...
              <h3 class="box-title">DNS信息添加</h3>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="<%=basePath %>admin/dns_add?refurl=${refurl}">
                <div class="form-group">
                  <label class="col-sm-2 control-label"> DNS账号 </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="dnsname"
									placeholder="DNS账号">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label"> 域名服务器 </label>
                  <div class="col-sm-10">
