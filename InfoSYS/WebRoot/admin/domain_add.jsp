      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="<%=basePath %>admin/domain_add">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="sdomain"
									placeholder="上线域名">
                  </div>
                  <span class="warnmsg text-warning"></span> </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
	                  <select class="slan form-control" name="language">
		                  <option>-- 请选择一个语种 --</option>
	                      <option name="lan_add" value="language?method=add">-- 新增一个语种 --</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="sdate" id="inputsdate"
