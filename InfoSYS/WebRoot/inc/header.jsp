  ...
  <nav class="navbar navbar-static-top" role="navigation"> 
    ...
    <div class="navbar-right">
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu">
            ...
            <li> 
              ...
              <ul class="menu">
                <li><!-- start message --> 
                  <a href="#">
                  <div class="pull-left"> <img src="../images/avatar5.png" class="img-circle" alt="User Image"/> </div>
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span><c:choose><c:when test="${user.name==null }">${user.id }</c:when><c:otherwise>${user.name }</c:otherwise></c:choose> <i class="caret"></i></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header bg-light-blue"> <img src="../images/avatar3.png" class="img-circle" alt="User Image" />
              <p> <c:choose><c:when test="${user.name==null }">${user.id }</c:when><c:otherwise>${user.name }</c:otherwise></c:choose> - Web Developer <small>Member since Nov. 2012</small> </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
            ...
            <li class="user-footer">
              <div class="pull-left"> <a href="<%=basePath %>admin/profile.jsp" class="btn btn-default btn-flat">个人资料</a> </div>
              <div class="pull-right"> <a href="<%=basePath %>user/login?method=logout" class="btn btn-default btn-flat logout">注销</a> </div>
            </li>
          </ul>
        </li>
      </ul>
